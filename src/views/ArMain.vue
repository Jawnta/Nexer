<template>
    ...
    <div ref="overlay" id="overlay">
        ...
        <a ref="rotate_right" v-show="containerIsPlaced" class="arrow right"><svg width="60" height="60" viewBox="0 0 24 24" fill="#fffff" xmlns="http://www.w3.org/2000/svg">
        ...
        <a ref="rotate_left"  v-show="containerIsPlaced" class="arrow left"><svg width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
